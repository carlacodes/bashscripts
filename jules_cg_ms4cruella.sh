...
#$ -N spikesortJob1_ms4cruellaBB2BB3_26112022
...
cp ~/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_cruella.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_cruella.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobGPU26112022BB2BB3_CRUELLA_1_$JOB_ID.tar.gz $TMPDIR
