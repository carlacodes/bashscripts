...
#$ -N LSTMjob_eclair_leavepout_06122022_1
...
cp ~Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_eclair.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_eclair.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTM05122022_eclair_1_$JOB_ID.tar.gz $TMPDIR
