...
#$ -N LSTMjob_ZOLA_leavepout_07122022_5_GPU
...
cp ~/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_zola.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_zola.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTM07122022_ZOLA_5_$JOB_ID.tar.gz $TMPDIR
