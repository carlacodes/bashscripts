...
#$ -N LSTMjob_nala_kfold_bypitch_1_16012023
...
cp ~/home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cvkfold_score_classification_nala_bypitch.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cvkfold_score_classification_nala_bypitch.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTMbypitch16012023nala_3_$JOB_ID.tar.gz $TMPDIR
