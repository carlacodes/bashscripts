...
#$ -N LSTMjob_Nala_leavepout_09122022_2
...
cp ~/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_nala.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_nala.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTM09122022_NALA_2_$JOB_ID.tar.gz $TMPDIR
