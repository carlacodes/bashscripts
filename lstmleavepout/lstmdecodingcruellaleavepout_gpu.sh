...
#$ -N LSTMjob_cruella_leavepout_GPU_08122022_2
...
cp ~Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_cruella.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_cruella.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTM07122022_cruella_2_$JOB_ID.tar.gz $TMPDIR
