...
#$ -N LSTMjob_crumble_kfold_14012023_1
...
cp ~/home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cvkfold_score_classification_crumble.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cvkfold_score_classification_crumble.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTM14012023CRUMBLE_1_$JOB_ID.tar.gz $TMPDIR
