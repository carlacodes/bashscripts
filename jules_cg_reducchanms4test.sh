...
#$ -N spikesortJob2_reducchantest19092022
...
cp ~/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_reducchan2test.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_reducchan2test.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobGPU13092022_1_$JOB_ID.tar.gz $TMPDIR
