...
#$ -N spikesortJob3_ms4NALABB2BB3_26112022
...
cp ~/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_nala.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_nala.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobGPU26112022BB2BB3_NALA_3_$JOB_ID.tar.gz $TMPDIR
