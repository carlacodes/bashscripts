...
#$ -N Matlab_eclair4_pitchshift_04072022
...
cp ~/code/write_to_bin_ks/myriad_upload/eclair_classifysweeps_distvdist_reduced.m $TMPDIR
...
matlab -nosplash -nodesktop -nodisplay < eclair_classifysweeps_distvdist_reduced.m
