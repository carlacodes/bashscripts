...
#$ -N spikesortJob1_reducchan02102022
...
cp ~/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_reducchanv6.py $TMPDIR
...
#everything but the fourth row = v5
python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_reducchanv6.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobGPUmountainsort01_102022_1_$JOB_ID.tar.gz $TMPDIR
