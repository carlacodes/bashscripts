...
#$ -N Matlab_crumble3_03072022_pitchshiftreducedfeb21
...
cp ~/code/write_to_bin_ks/myriad_upload/crumble_classifysweeps_distvdist_reducedPS.m $TMPDIR
...
matlab -nosplash -nodesktop -nodisplay < crumble_classifysweeps_distvdist_reducedPS.m
