...
#$ -N Matlab_Zola7_nps_20082022L27
...
cp ~/code/write_to_bin_ks/myriad_upload/Zola_classifysweeps_distvdist_reducednPSL27.m $TMPDIR
...
matlab -nosplash -nodesktop -nodisplay < Zola_classifysweeps_distvdist_reducednPSL27.m
