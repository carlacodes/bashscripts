...
#$ -N spikesortJob1_ms4eclairBB2BB315112022
...
cp ~/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_eclair.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4_eclair.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobGPU14112022b2bb3_eclair_1_$JOB_ID.tar.gz $TMPDIR
