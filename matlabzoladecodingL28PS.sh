...
cp ~/code/write_to_bin_ks/myriad_upload/Zola_classifysweeps_distvdist_reducedPSL28.m $TMPDIR
...
matlab -nosplash -nodesktop -nodisplay < Zola_classifysweeps_distvdist_reducedPSL28.m
