...
#$ -N Matlab_eclair4_04072022_nopitchshiftreduced
...
cp ~/code/write_to_bin_ks/myriad_upload/eclair_classifysweeps_distvdist_reducednPS.m $TMPDIR
...
matlab -nosplash -nodesktop -nodisplay < eclair_classifysweeps_distvdist_reducednPS.m
