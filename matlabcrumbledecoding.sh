...
#$ -N Matlab_crumble3_03072022nopitchshiftreducedfeb21
...
cp ~/code/write_to_bin_ks/myriad_upload/crumble_classifysweeps_distvdist_reducedfeb21.m $TMPDIR
...
echo ""
echo "Running matlab -nosplash -nodisplay < crumble_classifysweeps_distvdist.m ..."
echo ""

matlab -nosplash -nodesktop -nodisplay < crumble_classifysweeps_distvdist_reducedfeb21.m
