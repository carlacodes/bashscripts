...
#$ -N LSTMjob_Crumble_leavepout_06122022_1
...
cp ~Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_crumble.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cv_leavepout_score_classification_crumble.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTM06122022_crumble_1_$JOB_ID.tar.gz $TMPDIR
