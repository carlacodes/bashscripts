...
cp ~/Scratch/zceccgr/neuropixelsdecodingproject/runspikesortingnptest_pykilosort.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/neuropixelsdecodingproject/runspikesortingnptest_pykilosort.py
# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_job_pykilosort_fet_27012023_S1_1_$JOB_ID.tar.gz $TMPDIR
