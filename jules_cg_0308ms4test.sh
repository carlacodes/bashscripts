...
source /home/zceccgr/spkenv3/bin/activate
...
python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/tmpdirtest.py

#python /home/zceccgr/Scratch/zceccgr/spikeinterface3cg/interfacetest_jules_cg_kilosort_concatenate_ms4.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobGPU03082022_10_$JOB_ID.tar.gz $TMPDIR
