...
#$ -N LSTMjob_ZOLA_SHUFFLE_lesshours_181222_2
...
cp ~/home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cvkfold_score_classification_zola_shuffle.py $TMPDIR
...
python /home/zceccgr/Scratch/zceccgr/lstmdecodingproject/leavepoutcrossvalidationlstmdecoder/cgeuclidean_cvkfold_score_classification_zola_shuffle.py

# 10. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/files_from_jobLSTMDHUFFLE18122022ZOLA_2_$JOB_ID.tar.gz $TMPDIR
