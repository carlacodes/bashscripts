...
#$ -N Matlab_eclair3_03072022_nopitchshiftreducedfeb21
...
cp ~/code/write_to_bin_ks/myriad_upload/eclair_classifysweeps_distvdist_reducednPSfeb21.m $TMPDIR
...
echo ""
echo "Running matlab -nosplash -nodisplay < eclair_classifysweeps_distvdist_reduced.m ..."
echo ""

matlab -nosplash -nodesktop -nodisplay < eclair_classifysweeps_distvdist_reducednPSfeb21.m
