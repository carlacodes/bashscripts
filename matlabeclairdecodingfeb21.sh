...
#$ -N Matlab_eclair3_ps_03072022feb21
...
cp ~/code/write_to_bin_ks/myriad_upload/eclair_classifysweeps_distvdist_reducedfeb21.m $TMPDIR
...
matlab -nosplash -nodesktop -nodisplay < eclair_classifysweeps_distvdist_reducedfeb21.m
